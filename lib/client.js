...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var cssText =
      ...
      "html[data-dsh-skin-bg=image] [aria-selected=\"true\"]:not([role=\"tab\"]),html[data-dsh-skin-bg=image] [class*=\"selected\"]:not([role=\"tab\"]){color:var(--dsh-skin-on-accent,#fff)!important}" +

...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var cssText =
      ...
      "html[data-dsh-skin-bg=image] [role=\"treeitem\"][aria-selected=\"true\"]{color:var(--dsh-skin-on-accent,#fff)!important;background:var(--dsw-alias-brand-primary,#fff)!important}" +
      ...
      "html[data-dsh-skin-bg=image] [class*='_file']{color:var(--dsh-skin-on-accent,#fff)!important}" +
      // The composer notice / warning bar also sits on the
      // pure-accent hover background; flip its text to the accent-readable
      // pole so warnings stay legible in both appearances.
      "html[data-dsh-skin-bg=image] [class*='_warning']{color:var(--dsh-skin-on-accent,#fff)!important}" +
      ...
      "html[data-dsh-skin-bg=video] [role=\"treeitem\"][aria-selected=\"true\"]{color:var(--dsh-skin-on-accent,#fff)!important;background:var(--dsw-alias-brand-primary,#fff)!important}" +
      ...
      "html[data-dsh-skin-bg=video] [class*='_file']{color:var(--dsh-skin-on-accent,#fff)!important}" +
      "html[data-dsh-skin-bg=video] [class*='_warning']{color:var(--dsh-skin-on-accent,#fff)!important}" +

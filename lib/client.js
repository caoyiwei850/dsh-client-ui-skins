...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var cssText =
      ...
      "html[data-dsh-skin-frosted][data-dsh-skin-bg=image] [data-chat-flow-kind=assistant-step] [class*='_markdown_']," +
      "html[data-dsh-skin-frosted][data-dsh-skin-bg=video] [data-chat-flow-kind=assistant-step] [class*='_markdown_']{backdrop-filter:blur(8px) saturate(1.1);-webkit-backdrop-filter:blur(8px) saturate(1.1);background:rgba(255,255,255,0.45);border-radius:8px;padding:2px 6px;margin:-2px -6px}" +
      // dark appearance: a dark translucent tint instead, so light prose stays
      // legible over bright photo regions.
      "html[data-dsh-skin-frosted][data-dsh-skin-bg=image] body[data-ds-dark-theme] [data-chat-flow-kind=assistant-step] [class*='_markdown_']," +
      "html[data-dsh-skin-frosted][data-dsh-skin-bg=video] body[data-ds-dark-theme] [data-chat-flow-kind=assistant-step] [class*='_markdown_']{background:rgba(14,16,22,0.42)}";

...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var cssText =
      ...
      // pale in light mode). Use the live primary label token: it is dark on
      // the pale light cube and light on the deep dark cube.
      "html[data-dsh-skin-bg=image] [class*=\"themeCube\"][class*=\"selected\"]{color:var(--dsw-alias-label-primary,#1a1d24)!important}" +
